...
#define Servo_PWM D2 // A descriptive name for D6 pin of Arduino to provide PWM signal
...
void setup() {
  ...
  MG995_Servo.attach(Servo_PWM, 500, 2400);  // Connect D6 of Arduino with PWM signal pin of servo motor

}

void loop() {
  Serial.println("0");// You can display on the serial the signal value
  MG995_Servo.write(10); //Turn clockwise at high speed
  delay(3000);
